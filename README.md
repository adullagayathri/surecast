...
This project was built against a written contract and hardened by adversarial review (including a dedicated focus on hunting leakage). The process and findings are documented in docs/REVIEW.md.

## Run it

```bash
git clone https://github.com/adullagayathri/surecast && cd surecast
uv sync
...
Gayathri is an AI Engineer with experience in developing and deploying machine learning systems, generative AI, and MLOps infrastructure. She maintains this project as part of a portfolio focused on production-grade AI/ML engineering and robust time-series forecasting.